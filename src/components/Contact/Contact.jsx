...
function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    const SERVICE_ID = 'service_3w3fx8m'
    const TEMPLATE_ID = 'template_5v95yzg'
    const PUBLIC_KEY = 'mF_KB3UyzyMF8onG-'
          ...
          <div className="contact-info">
            ...
            <div className="contact-details">
              ...
              <div className="contact-item">
                ...
                <div>
                  <h4>Phone</h4>
                  <a href="tel:+919425340813">+91 94253 40813</a>
                </div>
              </div>
            ...
            <div className="social-links-section">
              ...
              <div className="social-links">
                <a 
                  href="https://linkedin.com/in/Sarthak-Vaishampayan" 
                  target="_blank" 
                ...
                <a 
                  href="https://instagram.com/_sxrthxkk_" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="social-link"
